...
# Author: Yang Lei
#
# Note: this is based on the MATLAB code, "autoRIFT", written by Alex Gardner,
...
try:
    ...
    #Try for global Autorift
    from  Autorift import Autorift
except:
    raise Exception('Autorift does not appear to be installed.')

class AutoriftISCE(Component, Autorift):
    '''
    ...
    def __init__(self):
        ...
        super(AutoriftISCE, self).__init__()
